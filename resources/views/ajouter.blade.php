...
<div class="navbar">
    ...
    <div class='nouveau'>   
    <div class="sidenav">
            <a href="/clients"><button class="btn lien-active btn-success">listes</button></a>
            <a href="/nouveau"><button class="btn btn-success">ajouter</button></a>
        </div>
        <div class="content">          
        <div class="nouveau-details">
            <h2>AJOUTER LE CLIENT ICI</h2>
        ...
        <form action="{{ route('store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="nouveau-form">
                ...
                <input type="number" name="cin" id="cin" placeholder='numero CIN' />
                <button type='submit' class='btn btn-danger' type="submit">AJOUTER</button>
            </div>
        </form>
        </div>
    </div>
